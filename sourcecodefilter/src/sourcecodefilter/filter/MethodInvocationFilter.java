...
public class MethodInvocationFilter extends ASTVisitor {
	...
	public boolean visit(MethodInvocation methodInvocation) {
		...
		for (String expectedMethodInvocation : methodInvocationsWithParameterToBeRemoved) {
			...
			if (methodInvocation.getName().toString().equals("addAllowedBrickField"))
			{
				methodInvocation.arguments().remove(1);
			}
		}
...
//		
//		
//		for (String expectedInvocation : SourceCodeFilter.removemethodInvocationParameterToBeRemoved)
//		{
//			
//			if (methodInvocation.getName().toString().equals("addAllowedBrickField"))
//			{
